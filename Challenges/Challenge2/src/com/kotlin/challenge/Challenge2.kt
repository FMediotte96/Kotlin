...
fun main() {
    ...
    // 3. Now declare an array of type non-nullable Short. Make it size 5 and assign it the values 1 to 5
    ...
    // public void method1(char[] charArray). Declare an array that you could pass to the method and
    // initialize it with the values 'a', 'b' and 'c'
